            ...
            <Row>
              <Form.Group>
                ...
                >
                  <option></option>
                  <option>Title</option>
                  <option>Episode Id</option>
                  <option>Opening Crawl</option>
      ...
      <div className="cards-container">
        {
          loading === false ? (
            ...
            result.map((item, index) => {
              return (
                <Card border="warning" className="film-card item" key={index}>
                  <Card.Header>{item.title}</Card.Header>
                  <Card.Body>
                    <Card.Text>
                      <span><b><u>Statistics</u></b></span><br />
                      <span><b>Episode Id:</b>&nbsp;&nbsp;{item.episode_id}</span><br/>
                      <span><b>Opening Crawl:</b>&nbsp;&nbsp;{item.opening_crawl}</span><br/>
                      <span><b>Director:</b>&nbsp;&nbsp;{item.director}</span><br/>
                      <span><b>Producer:</b>&nbsp;&nbsp;{item.producer}</span><br/>
                      <span><b>Release Date:</b>&nbsp;&nbsp;{item.release_date}</span><br/>
                    </Card.Text>
                  </Card.Body>
                </Card>
              );              
