...
function Starships() {
  ...
  function useAsyncHook(params) {
    ...
    useEffect(() => {
      async function fetchStarshipsList() {
        try {
          setLoading(true);
  ...
  return (
    <div className="content">
            ...
            <Row>
              <Form.Group>
                ...
                >
                  ...
                  <option>Crew</option>
                  <option>Hyperdrive Rating</option>
      ...
      <div className="cards-container">
        {
          loading === false ? (
            <h1>Search for Starships</h1>
          ) : loading === null ? (
            <h1>No Starships Found</h1>
          ) : (
            result.map((item, index) => {
              return (
                <Card border="warning" className="starship-card item" key={index}>
                  ...
                  <Card.Body>
                    <Card.Text>
                      ...
                      <span><b>Starship Class:</b>&nbsp;&nbsp;{item.starship_class}</span><br/>
                      <span><b>Length:</b>&nbsp;&nbsp;{item.length}</span><br/>
                      <span><b>Max Speed:</b>&nbsp;&nbsp;{item.max_atmosphering_speed}</span><br/>
                      <span><b>Hyperdrive Rating:</b>&nbsp;&nbsp;{item.hyperdrive_rating}</span><br/>
                      <span><b>MGLT:</b>&nbsp;&nbsp;{item.mglt}</span><br/>
